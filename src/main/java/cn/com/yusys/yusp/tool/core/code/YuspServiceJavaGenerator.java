...
public class YuspServiceJavaGenerator extends AbstractJavaGenerator {

   

    public YuspServiceJavaGenerator() {
        super();
    }
    ...
    public List<CompilationUnit> getCompilationUnits() {
		...
		try {
			...
			String htmlCode = FreeMarkerTemplateUtils.processTemplateIntoString(freemarkerConfiguration.getTemplate("htmlCode.ftl"), model);
			System.out.println(htmlCode);
			
			FileUtil.writeNewContentToFile(filepath+File.separator+tableDto.getDomainname()+".html", htmlCode);
			String jsCode = FreeMarkerTemplateUtils.processTemplateIntoString(freemarkerConfiguration.getTemplate("jsCode.ftl"), model);
			System.out.println(jsCode);
			FileUtil.writeNewContentToFile(filepath+File.separator+tableDto.getDomainname()+".js", jsCode);
